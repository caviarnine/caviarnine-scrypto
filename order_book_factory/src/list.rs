...
use crate::order_book_factory::order_book_factory::*;

#[derive(ScryptoSbor)]
pub struct List<T: ScryptoSbor + Clone + OrderBookFactoryRegisteredType> {
    pointer: u64,
    kvs: KeyValueStore<u64, T>,
}

impl<T: ScryptoSbor + Clone + OrderBookFactoryRegisteredType> List<T> {
    pub fn new() -> Self {
        Self { 
            pointer: 0,
