...
fn main() {
    ...
    write_package("WEIGHTED_POOL_PACKAGE", "WEIGHTED_POOL_PACKAGE", &decoder, &mut f);
    write_package("JUST_LOCKER_PACKAGE", "JUST_LOCKER_PACKAGE", &decoder, &mut f);
    write_component("JUST_LOCKER_COMPONENT", "_JUST_LOCKER_COMPONENT", &decoder, &mut f);
}
